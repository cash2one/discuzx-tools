    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('key_name', models.CharField(max_length=80, null=True, verbose_name='key name', blank=True)),
                ('down_link', models.CharField(max_length=150, null=True, verbose_name='down link', blank=True)),
                ('md5sum', models.CharField(max_length=80, null=True, verbose_name='md5sum', blank=True)),
                ('plate', models.IntegerField(null=True, verbose_name='plate', blank=True)),
                ('status', models.IntegerField(null=True, verbose_name='status', blank=True)),
                ('author', models.CharField(max_length=45, null=True, verbose_name='author', blank=True)),
                ('create_datetime', models.DateTimeField(verbose_name='create datetime')),
                ('upload_datetime', models.DateTimeField(null=True, verbose_name='upload datetime', blank=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dz_uid', models.IntegerField(null=True, verbose_name='dz uid', blank=True)),
                ('create_datetime', models.DateTimeField(verbose_name='create datetime')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.IntegerField(serialize=False, verbose_name='id', primary_key=True)),
                ('fid', models.IntegerField(null=True, verbose_name='fid', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attachment_id', models.IntegerField(null=True, verbose_name='attachment id', blank=True)),
                ('robot_data_id', models.IntegerField(null=True, verbose_name='robot data id', blank=True)),
                ('create_datetime', models.DateTimeField(verbose_name='create datetime')),
            ],
            options={
